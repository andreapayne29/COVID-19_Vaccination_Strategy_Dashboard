...
pfizerVaccinations = (186030/11078186)*1000000  ## number of pfizer vaccines distributed on Feb 18th divided by Ontario's eligible population (found in server.R)
modernaVaccinations = (47400/11078186)*1000000 ## number of Moderna vaccines distributed on Feb 18th div by Ontario's eligible population
